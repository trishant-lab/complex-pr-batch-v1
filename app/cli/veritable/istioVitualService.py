...
class IstioVirtualService(K8sResourceBaseClass):
    ...
    def __init__(self: "IstioVirtualService", veritable: VeritableSpec) -> None:
        """
    ...
    def payload(self: "IstioVirtualService") -> None:
        """
        payload
        """
        http_list = []
        ...
        if self.env != "production":
            http_redirect = {
                ...
                "redirect": {"uri": f"/{self.veritable.imageTag}/"},
            }
        ...
        body = {
            ...
            "spec": {
                "hosts": [f"{self.veritable.tenant}.{self.veritable_config.domain_name}"],
    ...
    def delete(self: "IstioVirtualService") -> None:
        ...
        try:
            self.k8s_dynamic_client.delete(
                resource=self.resource, name=f"{ProductName}-vs", namespace=self.veritable.tenant
            )
