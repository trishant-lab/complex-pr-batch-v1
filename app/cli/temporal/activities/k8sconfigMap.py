...
class K8sConfigMapCreationActivity(Activity):
    ...
    async def defn(activity_model: K8sConfigMapCreationActivityModel) -> None:
        ...
        with TemporaryDirectory() as temp_dir:
            ...
            with open(f"{temp_dir}/{activity_model.template_file_name}", "w") as f:
                f.write(output)
        ...
        body = V1ConfigMap(
            ...
            data={activity_model.template_file_name: open(f"{temp_dir}/{activity_model.template_file_name}").read()},
        )
