...
class PVC(K8sResourceBaseClass):
    ...
    def __init__(self: "PVC", dexit: DexitSpec) -> None:
    ...
    def payload(self: "PVC") -> dict:
        ...
        body = V1PersistentVolumeClaim(
            ...
            metadata=V1ObjectMeta(namespace=self.dexit.tenant, name=self.pvc_name),
    ...
    def delete(self: "PVC") -> None:
        ...
        """
        try:
            self.k8s_dynamic_client.delete(resource=self.resource, name=self.pvc_name, namespace=self.dexit.tenant)
