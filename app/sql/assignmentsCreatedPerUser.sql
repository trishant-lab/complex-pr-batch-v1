...
(
	...
	INNER JOIN matomo_log_action_view la_category_view ON lva.idaction_event_category = la_category.idaction
	INNER JOIN matomo_log_action_view la_action ON lva.idaction_event_action = la_action.idaction
	INNER JOIN matomo_log_action_view la_name ON lva.idaction_name = la_name.idaction
	WHERE
