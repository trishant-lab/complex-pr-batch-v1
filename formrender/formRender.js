...
envArg.forEach((data) => {
  ...
  filePaths[PATH[key]] = value;
});

// do not modify this jQuery function
!(function (e) {
  "use strict";
  !(function (e) {
    var t = {};
    ...
    function (t, n, r) {
      ...
      const l = function (e, t = !1) {
        ...
        f = (e) =>
          e.reduce((e, t) => e.concat(Array.isArray(t) ? f(t) : t), []),
        ...
        v = function (e, t = "", n = {}) {
          ...
          return (
            ...
            ((e, t) => {
              if (t)
                for (const n in t)
                  t.hasOwnProperty(n) && e.addEventListener(n, (e) => t[n](e));
            })(s, o),
            s
          );
        },
        ...
        q = (e) => {
          ...
          if (t) {
            ...
            for (let t = 0; t < e.length; t++) {
              ...
              o && o.length && (r.values = w(o)),
                i && i.length && (r.userData = O(i)),
                n.push(r);
            }
          }
          return n;
        ...
        P = (e, t) => {
          ...
          for (const r in t)
            n.hasOwnProperty(r) &&
              (Array.isArray(t[r])
                ? (n[r] = Array.isArray(e[r]) ? S(e[r].concat(t[r])) : t[r])
                : "object" == typeof t[r]
                ? (n[r] = P(e[r], t[r]))
                : (n[r] = t[r]));
          return n;
        ...
        $ = /^col-(xs|sm|md|lg)-([^\s]+)/,
        _ = (e) =>
          e.split(" ").filter((e) => $.test(e) || e.startsWith("row-"));
      function V(e) {
        const t = [
            "a",
            "an",
    ...
    function (e, t, n) {
      ...
      class a {
        ...
        static register(e, t, n) {
          ...
          for (const n of e)
            -1 === n.indexOf(".")
              ? (a.classRegister[r + n] = t)
              : a.error(
                  `Ignoring type ${n}. Cannot use the character '.' in a type name.`
                );
        }
        ...
        on(e) {
          const t = {
            ...
            render: (e) => {
              ...
              this.css && Object(r.p)(this.css),
                this.js && !Object(r.s)(this.js)
                  ? Object(r.o)(this.js).done(t)
                  : t();
            },
          };
          return e ? t[e] : t;
                    ...
                    if (t && o)
                      if ("object" === (void 0 === t ? "undefined" : r(t)))
                        for (var s = 0; s < o.length; s++)
                          (i = o[s].substring(1, o[s].length - 1)),
                            (n = n.replace(this.makeSafe(o[s]), t[i] || ""));
    ...
    function (e, t, n) {
      ...
      const i = {
        ...
        a = { location: "https://formbuilder.online/assets/lang/" },
        l = {},
        c = {
    ...
    function (e, t, n) {
      ...
      class s extends r.a {
        static register(e = {}, t = []) {
          (s.customRegister = {}),
            s.def || (s.def = { icon: {}, i18n: {} }),
            (s.templates = e);
          const n = i.a.locale;
          s.def.i18n[n] || (s.def.i18n[n] = {}),
            r.a.register(Object.keys(e), s);
          for (const o of t) {
            let t = o.type;
            ...
            if (!e[t]) {
              ...
              (i = o.datatype
                ...
                (s.customRegister[i] = jQuery.extend(o, {
                  type: t,
                  class: e,
                }));
            }
    ...
    function (e, t, n) {
      ...
      const o = (e, t) => {
        ...
        if (e.className) {
          ...
          o && o.length > 0 && (n += " " + o.join(" ")),
            t.classList && t.classList.remove(...o);
        }
        return n;
      };
      class i {
        constructor(e, t) {
          (this.preview = t),
            (this.templates = {
              ...
              default: (e, t, n, r) => (
                n && t.appendChild(n),
                this.markup("div", [t, e], { className: o(r, e) })
              ),
              noLabel: (e, t, n, r) =>
                this.markup("div", e, { className: o(r, e) }),
              hidden: (e) => e,
            }),
        ...
        build(e, t, n) {
          ...
          return (
            o.on("prerender")(c),
            c.addEventListener("fieldRendered", o.on("render")),
            c
          );
        }
        label() {
    ...
    function (t, n, r) {
      ...
      class a extends o.a {
          ...
          const e = this.config,
            ...
            a = {
              focus: (e) => {
                ...
                if (
                  (e.target.addEventListener("keydown", o),
        ...
        selectOption(e, t) {
          ...
          for (let e = 0; e < n.length; e++)
            n[e].classList.remove("active-option");
      ...
      class m extends o.a {
        ...
        build() {
          const e = [],
            ...
            p = "select" === i;
          if (
            ((c.multiple || "checkbox-group" === i) && (c.name = c.name + "[]"),
            "checkbox-group" === i && c.required)
          ) {
            const e = this,
          ...
          if ((delete c.title, n)) {
            o &&
              ...
              e.push(
                ...
                this.markup("option", o, { disabled: true })
              );
            for (let t = 0; t < n.length; t++) {
              ...
              if (
                ((d.id = `${c.id}-${t}`),
                (d.selected && !o) || delete d.selected,
                void 0 !== r && d.value === r && (d.selected = !0),
                p)
              ) {
          ...
          return (
            (this.dom =
              "select" == i
                ? this.markup(u, e, Object(d.D)(c, !0))
                ...
                callbacks: {
                  onError: (n, r, o) => {
                    ...
                    const i = e("<div />")
                        ...
                        .html(
                          `<span>Error processing upload: <b>${r}</b>.<br />Reason: ${o}</span>`
                        )
                  ...
                  onStatusChange: (e, r, o) => {
                    const i = t.fineUploader("getUploads"),
                      s = [];
                    for (const e of i)
                      "upload successful" == e.status && s.push(e.name);
                    return (
                      n.val(s.join(", ")), { id: e, oldStatus: r, newStatus: o }
                    );
                  },
                },
      ...
      class v extends o.a {
        ...
        build() {
          ...
          return (
            delete n.type,
            (this.field = this.markup("textarea", this.parsedHtml(t), n)),
            this.field
          );
        }
        onRender() {
      ...
      class k extends v {
        ...
        build() {
          ...
          return (
            delete n.type,
            (this.field = this.markup("div", null, n)),
            this.field
          );
        }
        onRender(e) {
        ...
        santizeField(e, t) {
          ...
          return (
            ...
            (n.className = Array.isArray(e.className)
              ? s.g.unique(e.className.join(" ").split(" ")).join(" ")
              : e.className || e.class || null),
            delete n.class,
            e.values && (e.values = e.values.map((e) => s.g.trimObj(e))),
            s.g.trimObj(n)
          );
        }
        getElement(e) {
        ...
        render(e = null, t = 0) {
          ...
          if (r.formData) {
            ...
            if ((e && (this.instanceContainers[t] = e), r.render && e))
              e.emptyContainer(),
                e.appendFormFields(o),
                r.onRender && r.onRender(),
                r.notify.success(r.messages.formRendered);
            else {
        ...
        get userData() {
          ...
          return (
            t
              ...
              .forEach((e) => window.tinymce.get(e.name).save()),
      ...
      !(function (e) {
        ...
        const n = {
          init: (e, r = {}) => (
            (t = e),
            (n.instance = new f(r)),
            e.each((t) => n.instance.render(e[t], t)),
            n.instance
          ),
...
// custom jQuery Form renderer
jQuery(($) => {
  const readFile = async (dir, outputDir) => {
    try {
  ...
  const readData = async () => {
    try {
      const formDir = `${filePaths[PATH.inputDir]}`;
      const outputFormDir = `${filePaths[PATH.outputDir]}`;
      readFile(formDir, outputFormDir);
    } catch (e) {
      console.error(e);
    }
  };
