	...
	!(function (e) {
		...
		function (t, n, r) {
			...
			const l = function (e, t = !1) {
					...
					t && n.push(!1);
					for (const t in e)
						n.includes(e[t]) ? delete e[t] : Array.isArray(e[t]) && (e[t].length || delete e[t]);
					return e;
				},
				c = function (e) {
				...
				p = (e, t) => {
					...
					return (
						...
						t &&
							(Array.isArray(t)
								? (n = k(t.join(' ')))
								: ('boolean' == typeof t && (t = t.toString()), (n = k(t.trim())))),
						{ name: e, value: (t = t ? `="${n}"` : '') }
					);
				},
			...
			function V(e) {
				...
				return ('' + e).replace(
					n,
					(e) => e.charAt(0).toUpperCase() + e.substr(1).replace(/[A-Z]/g, (e) => ' ' + e),
				);
			}
			const Q = {
				addEventListeners: N,
			...
			const W = (e) =>
				Object.entries(e).reduce((e, [t, n]) => i(i({}, e), {}, { [t + 'Selector']: '.' + n }), {});
			n.g = Q;
		},
		function (e, t, n) {
			n.d(t, 'a', function () {
				...
				static register(e, t, n) {
					...
					for (const n of e)
						-1 === n.indexOf('.')
							...
							: a.error(`Ignoring type ${n}. Cannot use the character '.' in a type name.`);
				}
					...
					const t = {
						...
						render: (e) => {
							...
							this.css && Object(r.p)(this.css),
								this.js && !Object(r.s)(this.js) ? Object(r.o)(this.js).done(t) : t();
						},
					};
					return e ? t[e] : t;
				}
						...
						a = (t.I18N = (function () {
							...
							return (
								...
								(e.prototype.init = function (e) {
									return (
										this.processConfig.call(this, Object.assign({}, this.config, e)),
								...
								(e.prototype.getValue = function (e) {
									var t =
										arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.locale;
				...
				static register(e = {}, t = []) {
					...
					for (const o of t) {
						...
						if (!e[t]) {
							...
							(i = o.datatype ? o.datatype : `${t}-${Math.floor(9e3 * Math.random() + 1e3)}`),
		...
		function (e, t, n) {
			...
			class i {
				constructor(e, t) {
					(this.preview = t),
						(this.templates = {
							...
							help: null,
							default: (e, t, n, r) => (
								n && t.appendChild(n), this.markup('div', [t, e], { className: o(r, e) })
							),
				...
				configure() {}
				build(e, t, n) {
					this.preview && (t.name ? (t.name = t.name + '-preview') : (t.name = r.g.nameAttr(t) + '-preview')),
						(t.id = t.name),
		...
		function (t, n, r) {
									...
									() => {
										r
											? ((e.target.value = r.innerHTML),
												...
												'none' === t.style.display ? this.showList(t, r) : this.hideList(t))
			...
			class k extends v {
				configure() {
					const e = {
							modules: {
								toolbar: [[{ header: [1, 2, !1] }], ['bold', 'italic', 'underline'], ['code-block']],
							},
		...
		function (t, n, r) {
			...
			!(function (e) {
				...
				const n = {
					init: (e, r = {}) => (
						(t = e), (n.instance = new f(r)), e.each((t) => n.instance.render(e[t], t)), n.instance
					),
